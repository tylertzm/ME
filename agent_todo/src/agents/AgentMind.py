...
class AgentMind:
    def __init__(self) -> None:
        ...
        self.messages = [Message(
            role="system",
            content="You are an AI assistant that helps the user reflect on their thoughts and emotions. Encourage open-minded thinking, journaling, and self-reflection."
        )]
